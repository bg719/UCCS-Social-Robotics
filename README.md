...
The development of a Social Interactivity Mentor for Youth with Autism using the NAO robot (SIMYAN) software platform. This platform will include an SDK supporting advanced social interactivity behaviors and a social interactive drawing module which implements the SDK for that specific scenario.
